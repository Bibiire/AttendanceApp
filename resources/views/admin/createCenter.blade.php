            ...
            <div class="content_wrapper">
                ...
                <div class="registration_page center_container">
                    <div class="center_content">
                        ...
                        <form action="{{ route('create.center') }} " method="post">
                           @csrf 
                           
                            <div class="form-group icon_parent">
                                <label for="name">Center Name</label>
                                <input  type="text" class="form-control" name="name" placeholder="Center Name">
                            ...
                            <select name="zone_id" class="form-select form-control"
                        ...
                        <div class="footer">
                            <p>Copyright &copy; 2020 CGCC. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div><!--/ content wrapper -->
