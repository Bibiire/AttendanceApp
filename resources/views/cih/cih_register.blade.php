        ...
        <div class="content_wrapper">
            ...
            <div class="registration_page center_container">
                <div class="center_content">
                    ...
                    <form action="{{ route('cih.register.create') }} " method="post">
                        ...
                        <div class="form-group icon_parent">
                            ...
                            <select onchange="calls()" id="zone" name="zone_id" class="form-select form-control"
                                aria-label="Default select example">
                                <option selected>Please select Zone</option>
                                @if ($zones != null)
                                    @foreach ($zones as $zone)
                                        <option value="{{ $zone->id }}">{{ $zone->names }}</option>
                                    @endforeach
                                @endif
                            </select>
                        ...
                        <div class="form-group icon_parent">
                            ...
                            <div class="controls">
                                <select name="center_id" class="form-control">
                                    <option value="" selected="" disabled="">Center</option>
                                </select>
...
function calls(){
    var zone_id = document.getElementById("zone").value;
                ...
                if (zone_id) {
                    $.ajax({
                        url: "{{ url('getCenters/ajax') }}/" + zone_id,
                        type: "GET",
                        dataType: "json",
                        success: function(data) {
                            
                            var d = $('select[name="center_id"]').empty();
                            $.each(data, function(key, value) {
                                // alert(value.id);
                                $('select[name="center_id"]').append(
