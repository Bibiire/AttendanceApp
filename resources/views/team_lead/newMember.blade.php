...
<div class="content-header">
      <div class="container-fluid">
        ...
        @endif
    <div class="mx-3">
        <h2>Welcome Pastor {{ Auth::guard('team_lead')->user()->namess }}</h2>
        ...
        <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">New Joiners</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$member->names}}</td>
                    <td>
                      <a href="{{route('joiner.view', $member->id)}}" class="btn btn-secondary">View Details</a>
                    </td>
                  </tr>
                  @endforeach
