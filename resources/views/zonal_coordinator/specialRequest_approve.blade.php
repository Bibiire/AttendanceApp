    ...
    <div class="container">
        ...
        <p class='text-center'> The information you provide in this form will be treated with confidentiality</p>
            ...
            @if($specialRequest->status == 2)
                <h3 class="bg-success text-center text-light">Approved</h3>
            @elseif($specialRequest->status == 3)
                <h3 class="bg-danger text-center text-light">Rejected</h3>
            @endif
        ...
        @if($specialRequest->status == 1)
            <div class="row mt-3">
                <form class='col-sm-6' action="{{ route('approve.request', $specialRequest->id) }}" method="post">
                    @csrf
                    <input type="hidden" name="id" value="{{ $specialRequest->id }}">
                ...
                <form class='col-sm-6' action="{{ route('reject.request', $specialRequest->id) }}" method="post">
            ...
            @else -->
            <a class="btn btn-primary form-control mt-5" href="{{route('specials.request')}}">Back</a>
            <!-- @endif -->
    </div>
</body>
