        ...
        <div class="card-body">
          <form >
            ...
            <div>
              ...
              <div class="form-group form-inline ">
                <label for="">Adult</label>
                <input type="number" class="form-control mx-4" name="maleAdult" value='{{$attendance->maleAdult}}' id="maleAdult" style="width:100px">
                <label for="">Youth</label>
                <input type="number" class="form-control mx-4" name="maleYouth" value='{{$attendance->maleYouth}}' id="maleYouth" style="width:100px">
                <label for="">Teenager</label>
                <input type="number" class="form-control mx-4" name="maleTeen" value='{{$attendance->maleTeen}}' id="maleTeen" style="width:100px">
                <label for="">Children</label>
                <input type="number" class="form-control mx-4" name="maleChild" value='{{$attendance->maleChild}}' id="maleChild" style="width:100px">
              </div>
            </div>
            <div class="row">
          ...
          <a class="btn btn-outline-primary" href="{{route('core_leaders.cih')}}">Back</a>
        </div>
        <!-- /.card-body -->
      </div>
      <!-- /.card -->
